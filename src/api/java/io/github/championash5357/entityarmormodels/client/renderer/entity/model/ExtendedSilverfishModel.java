...
public class ExtendedSilverfishModel<T extends LivingEntity> extends ExtendedSegmentedModel<T, SilverfishModel<T>> {
	...
	public ExtendedSilverfishModel(float modelSizeIn) {
		this(modelSizeIn, 64, 32);
	}

	public ExtendedSilverfishModel(float modelSizeIn, int textureWidthIn, int textureHeightIn) {
		...
		for(int i = 0; i < this.silverfishBodyParts.length; ++i) {
			...
			this.silverfishBodyParts[i].addBox((float)SILVERFISH_BOX_LENGTH[i][0] * -0.5F, 0.0F, (float)SILVERFISH_BOX_LENGTH[i][2] * -0.5F, (float)SILVERFISH_BOX_LENGTH[i][0], (float)SILVERFISH_BOX_LENGTH[i][1], (float)SILVERFISH_BOX_LENGTH[i][2], modelSizeIn);
		...
		this.silverfishWings[0].addBox(-5.0F, 0.0F, (float)SILVERFISH_BOX_LENGTH[2][2] * -0.5F, 10.0F, 8.0F, (float)SILVERFISH_BOX_LENGTH[2][2], modelSizeIn);
		this.silverfishWings[0].setRotationPoint(0.0F, 16.0F, this.zPlacement[2]);
		this.silverfishWings[1] = new ModelRenderer(this, 20, 11);
		this.silverfishWings[1].addBox(-3.0F, 0.0F, (float)SILVERFISH_BOX_LENGTH[4][2] * -0.5F, 6.0F, 4.0F, (float)SILVERFISH_BOX_LENGTH[4][2], modelSizeIn);
		this.silverfishWings[1].setRotationPoint(0.0F, 20.0F, this.zPlacement[4]);
		this.silverfishWings[2] = new ModelRenderer(this, 20, 18);
		this.silverfishWings[2].addBox(-3.0F, 0.0F, (float)SILVERFISH_BOX_LENGTH[4][2] * -0.5F, 6.0F, 5.0F, (float)SILVERFISH_BOX_LENGTH[1][2], modelSizeIn);
