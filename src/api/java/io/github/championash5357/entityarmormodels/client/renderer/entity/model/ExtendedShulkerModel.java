...
public class ExtendedShulkerModel<T extends ShulkerEntity> extends ExtendedSegmentedModel<T, ShulkerModel<T>> {
	...
	public ExtendedShulkerModel(float modelSizeIn) {
	...
	public ExtendedShulkerModel(float modelSizeIn, int textureWidthIn, int textureHeightIn) {
		...
		this.lid.addBox(-8.0F, -16.0F, -8.0F, 16.0F, 12.0F, 16.0F, modelSizeIn);
		this.lid.setRotationPoint(0.0F, 24.0F, 0.0F);
		this.base.addBox(-8.0F, -8.0F, -8.0F, 16.0F, 8.0F, 16.0F, modelSizeIn);
		this.base.setRotationPoint(0.0F, 24.0F, 0.0F);
		this.head.addBox(-3.0F, 0.0F, -3.0F, 6.0F, 6.0F, 6.0F, modelSizeIn);
